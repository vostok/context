...
{
    /// <summary>
    /// <para>Represents mutable name-based ambient context properties.</para>
    ...
    public interface IContextProperties
    {
        ...
        /// <summary>
        /// <para>Sets given <paramref name="value"/> for a property with given <paramref name="name"/>.</para>
        /// <para>If a property with such <paramref name="name"/> does not exist, it gets created.</para>
        /// <para>If a property with such <paramref name="name"/> and a different value exists, it gets updated only if <paramref name="allowOverwrite"/> is <c>true</c>.</para>
        /// </summary>
        ...
        bool Set([NotNull] string name, [CanBeNull] object value, bool allowOverwrite = true);
